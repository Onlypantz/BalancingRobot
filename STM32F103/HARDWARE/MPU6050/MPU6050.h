...
/**
@header: Using I2C:
	@para: MODE_AF_OD, GPIO_NOPULL, AFIO_NONE*
	@note: if PB8,PB9 -> AFIO_I2C1_ENABLE
**/

#define I2C I2C2 		// using I2C1

#define Disable_Ack 0
#define Enable_Ack 	1
#define bit(x) (1<<x) // bit function - shift bit
...
extern ACCCEL_T_GYRO_UNION accel_t_gyro;
...
#define MPU6050_AFS_SEL_4G  0x01
#define MPU6050_AFS_SEL_8G  0x02
#define MPU6050_AFS_SEL_16G 0x03
